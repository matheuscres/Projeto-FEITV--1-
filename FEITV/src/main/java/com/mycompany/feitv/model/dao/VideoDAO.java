...
/**
 * Objeto de acesso a dados responsável pelos vídeos.
...
public class VideoDAO {
     ...
     * @return lista de vídeos cadastrados
     */
    ...
    /**
     * Atualiza os contadores de curtidas e descurtidas de um vídeo.
     * @param videoId ID do vídeo
     * @param likesDelta variação de likes
     * @param dislikesDelta variação de dislikes
     */
